...
connection.once('open', async () => {
  ...
  // Add students to the collection and await the results
   let createdStudents = await Student.collection.insertMany(students);
   
   let getCreatedStudents = await Student.collection.find().toArray();
   let studentIds = getCreatedStudents.map(student => student._id)
